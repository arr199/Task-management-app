      ...
      <AnimatePresence>
        {showLeftNavbar && (
          <motion.nav
            ...
            className={`z-10  min-h-[320px] rounded-lg border-r-0   absolute flex  
          ...
          >
            <button
              onClick={handleCloseLeftNavbar}
              className="md:hidden absolute right-5 top-5 hover:text-red-600 focus:text-red-600"
            >
              <ImCross></ImCross>
            </button>
            <div className={"w-[300px]  pr-10  py-1 text-[#828FA3] flex flex-col  "}>
              ...
              <ul className="boards-list  flex flex-col  mt-6 text-[14px]  md:w-[300px] max-h-[200px] md:max-h-[500px] overflow-y-scroll md:overflow-auto  ">
                {boards?.map((e, index) => (
                  <div key={e.id} className="flex items-center relative  ">
                    ...
                    <NavLink
                      ...
                      style={
                        Number(board) === index
                          ? { background: "#635FC7", color: "white", fontWeight: "bold" }
                          : { background: "" }
                      }
                ...
                ${
                  darkMode === "light"
                    ? " hover:text-[#635FC7]  hover:bg-[#635FC740]"
            ...
            {/*  DARK-MODE MENU */}
            <div
              className={` self-center mt-auto mb-4 px-16 py-4 flex gap-4  rounded 
            ...
            >
              ...
              >
                <div
                  className={` w-3 h-3 bg-white rounded-full border-black  ${
                    darkMode === "dark" ? " ml-auto " : " mr-auto "
                  } `}
                ></div>
              </div>
            ...
            <button
              ...
              className={`hidden py-3 px-10 rounded-r-3xl mt-4 w-[90%]  text-[#828FA3] hover:text-[#635FC7] font-bold md:flex  items-center gap-2 
               ${darkMode === "light" ? "hover:bg-[#635FC740] ] " : "  hover:bg-[#F4F7FD] "}`}
            >
              {" "}
              <BsEyeSlash></BsEyeSlash> Hide Sidebar
            </button>
          </motion.nav>
        )}
      </AnimatePresence>
